  ...
  return (
    <div style={{ padding: "24px", fontFamily: "sans-serif", maxWidth: 380 }}>
      ...
      <p style={{ color: "var(--fg-muted)", fontSize: 13, marginBottom: 24 }}>
        Hold the button for 600 ms to trigger the long press.
      </p>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
        ...
        >
          {pressing ? "Holding…" : "Hold to press"}
        </button>
        ...
        <div style={{
          ...
          <span style={{ fontSize: 13, color: "var(--fg-muted)" }}>Long presses triggered</span>
